                            ...
                            @forelse($subjects as $subject)
                                <tr>
                                    ...
                                    <td class="px-3 text-end">
                                        <div class="btn-group">
                                            <a href="{{ route('admin.subjects.show', $subject->id) }}" class="btn btn-sm btn-outline-primary">
                                                <i class="bi bi-eye"></i>
                                            </a>
                                            <a href="{{ route('admin.subjects.edit', $subject->id) }}" class="btn btn-sm btn-outline-secondary">
