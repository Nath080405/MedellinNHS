                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="section" id="section" class="form-select">
                                ...
                                <!-- Grade 8 Sections -->
                                <option value="Grade 8 - Section A" class="grade-8" {{ old('section', $student->student?->section) == 'Grade 8 - Section A' ? 'selected' : '' }}>Section A</option>
                                <option value="Grade 8 - Section B" class="grade-8" {{ old('section', $student->student?->section) == 'Grade 8 - Section B' ? 'selected' : '' }}>Section B</option>
                                <option value="Grade 8 - Section C" class="grade-8" {{ old('section', $student->student?->section) == 'Grade 8 - Section C' ? 'selected' : '' }}>Section C</option>
                                <!-- Grade 9 Sections -->
                                <option value="Grade 9 - Section A" class="grade-9" {{ old('section', $student->student?->section) == 'Grade 9 - Section A' ? 'selected' : '' }}>Section A</option>
                                <option value="Grade 9 - Section B" class="grade-9" {{ old('section', $student->student?->section) == 'Grade 9 - Section B' ? 'selected' : '' }}>Section B</option>
                                <option value="Grade 9 - Section C" class="grade-9" {{ old('section', $student->student?->section) == 'Grade 9 - Section C' ? 'selected' : '' }}>Section C</option>
                                <!-- Grade 10 Sections -->
                                <option value="Grade 10 - Section A" class="grade-10" {{ old('section', $student->student?->section) == 'Grade 10 - Section A' ? 'selected' : '' }}>Section A</option>
                                <option value="Grade 10 - Section B" class="grade-10" {{ old('section', $student->student?->section) == 'Grade 10 - Section B' ? 'selected' : '' }}>Section B</option>
                                <option value="Grade 10 - Section C" class="grade-10" {{ old('section', $student->student?->section) == 'Grade 10 - Section C' ? 'selected' : '' }}>Section C</option>
                                <!-- Grade 11 Sections -->
                                <option value="Grade 11 - Section A" class="grade-11" {{ old('section', $student->student?->section) == 'Grade 11 - Section A' ? 'selected' : '' }}>Section A</option>
                                <option value="Grade 11 - Section B" class="grade-11" {{ old('section', $student->student?->section) == 'Grade 11 - Section B' ? 'selected' : '' }}>Section B</option>
                                <option value="Grade 11 - Section C" class="grade-11" {{ old('section', $student->student?->section) == 'Grade 11 - Section C' ? 'selected' : '' }}>Section C</option>
                                <!-- Grade 12 Sections -->
                                <option value="Grade 12 - Section A" class="grade-12" {{ old('section', $student->student?->section) == 'Grade 12 - Section A' ? 'selected' : '' }}>Section A</option>
                                <option value="Grade 12 - Section B" class="grade-12" {{ old('section', $student->student?->section) == 'Grade 12 - Section B' ? 'selected' : '' }}>Section B</option>
                                <option value="Grade 12 - Section C" class="grade-12" {{ old('section', $student->student?->section) == 'Grade 12 - Section C' ? 'selected' : '' }}>Section C</option>
                            </select>
                        </div>
