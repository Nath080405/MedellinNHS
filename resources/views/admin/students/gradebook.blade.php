                ...
                <div class="gradebook-content" style="background-color: #ffffff; max-width: 1200px; margin: 0 auto;">
                    ...
                    <table class="table table-bordered grades-table">
                        ...
                        <tbody>
                            <tr>
                                <td>Mathematics</td>
                                <td class="first-sem">85</td>
                                <td class="first-sem">90</td>
                                <td class="second-sem" style="display: none;">90</td>
                                <td class="second-sem" style="display: none;">91</td>
                            </tr>
                            <tr>
                                <td>Science</td>
                                <td class="first-sem">88</td>
                                <td class="first-sem">87</td>
                                <td class="second-sem" style="display: none;">91</td>
                                <td class="second-sem" style="display: none;">90</td>
                            </tr>
                            <tr>
                                <td>Araling Panlipunan</td>
                                <td class="first-sem">95</td>
                                <td class="first-sem">91</td>
                                <td class="second-sem" style="display: none;">95</td>
                                <td class="second-sem" style="display: none;">94</td>
                            </tr>
                            <tr>
                                <td>English</td>
                                <td class="first-sem">92</td>
                                <td class="first-sem">90</td>
                                <td class="second-sem" style="display: none;">88</td>
                                <td class="second-sem" style="display: none;">90</td>
                            </tr>
                            <tr>
                                <td>Filipino</td>
                                <td class="first-sem">92</td>
                                <td class="first-sem">89</td>
                                <td class="second-sem" style="display: none;">94</td>
                                <td class="second-sem" style="display: none;">95</td>
                            </tr>
                            <tr>
                                <td>TLE</td>
                                <td class="first-sem">96</td>
                                <td class="first-sem">97</td>
                                <td class="second-sem" style="display: none;">97</td>
                                <td class="second-sem" style="display: none;">97</td>
                            </tr>
                        </tbody>
                        <tfoot>
