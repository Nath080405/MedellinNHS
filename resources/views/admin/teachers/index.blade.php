                    ...
                    <div class="card-body p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="mb-0 fw-bold">{{ $teachers->where('status', 'active')->count() }}</h3>
                            </div>
                        ...
                        <tbody>
                            @forelse($teachers as $teacher)
                                <tr class="shadow-sm">
                                    <td class="ps-3 py-3">
                                        <span
                                            class="badge bg-primary bg-opacity-10 text-primary px-2 py-1 fw-medium shadow-sm">{{ $teacher->username }}</span>
                                    </td>
                                    <td class="py-3">
                                    ...
                                    <td class="py-3">
                                        <span class="badge bg-{{ $teacher->status === 'active' ? 'success' : 'danger' }} text-capitalize px-2 py-1 fw-medium shadow-sm">
