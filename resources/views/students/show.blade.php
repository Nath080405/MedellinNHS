                    ...
                    <div class="text-center mb-4">
                        ...
                        <div class="d-flex justify-content-center gap-2">
                            <span class="badge bg-primary bg-opacity-10 text-primary px-3 py-2">
                                <i class="bi bi-mortarboard me-1"></i> {{ $student->grade ?? 'Not Assigned' }}
                            </span>
                    ...
                    <div class="row g-3">
                            ...
                            <div class="card shadow-lg h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <p class="mb-0">{{ $student->grade ?? 'Not Assigned' }}</p>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Section</label>
                                        <p class="mb-0">{{ $student->section ?? 'Not Assigned' }}</p>
                                    </div>
                                    <div class="mb-3">
                        ...
                        <div class="col-12">
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <h6 class="text-muted mb-3 small text-uppercase fw-semibold">Additional Information</h6>
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            <div class="mb-3">
