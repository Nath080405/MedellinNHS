...
<div class="d-flex justify-content-between align-items-center mb-5">
 ...
 <div class="content p-4 rounded bg-light shadow-sm mb-4 d-flex align-items-center justify-content-between"> 
      <div class="d-flex align-items-center">
        <img src="{{ asset('images/mae-removebg-preview.png') }}" alt="Teacher" class="img-fluid me-4" style="max-width: 120px;">
        <div>
          @if (Auth::check())
      ...
      <div>
        <a href="{{ route('teachers.events.addEvents') }}" class="btn btn-primary bt-lg rounded-pill shadow-sm">
